  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="input-group">
        ...
        <input type="text" class="form-control" maxlength="20"  placeholder="50% de descuento" this.value = this.value.toUpperCase();" id="descripcion" name="descripcion" required>
...
?>
        ...
        <input type="text" class="form-control" id="codigo" name="codigo" readonly  value=<?php echo generarCodigo(6);  ?> >
        </div>
       <br>
        <div class="input-group ">

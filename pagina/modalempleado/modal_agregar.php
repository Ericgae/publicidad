<form class="form-group" method="POST" action="../guardar/guardaEmpleado.php">
...
<script src="js/ajax.js"></script>
        ...
        <input type="text" class="form-control" placeholder="212121" onkeypress="return SoloNumeros(event);" onKeyUp="this.value = this.value.toUpperCase();" maxlength="10" id="tel" name="tel" required>
        </div>
        <br>
        <div class="input-group ">
        <span class="input-group-addon"> Tipo:</span>
        <select id="tipoE" name="tipoE" class="form-control" required>
        ...
        <input type="text" class="form-control" placeholder="contraseña"  onKeyUp="this.value = this.value.toUpperCase();" maxlength="20" id="usuario" name="usuario" required>
        </div>
        <br>
        <div class="input-group ">
        <span class="input-group-addon"> contraseña:</span>
        <input type="password" class="form-control"    maxlength="20" id="password" name="password" required>
        </div>
        <br>

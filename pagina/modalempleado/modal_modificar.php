  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="input-group">
        ...
        <input type="text" class="form-control" maxlength="20"  placeholder="lopez" onkeypress="return soloLetras(event);" onKeyUp="this.value = this.value.toUpperCase();" id="apellidop" name="apellidop" required>
       ...
       <br>
        ...
        <input type="number" type="number"  class="form-control" onKeyPress="return SoloNumeros(event);" placeholder="14" id="tel" name="tel" required>
        </div>
        <br>
          <div class="input-group ">

...
require_once dirname(__FILE__).'../../Classes/PHPWord-master/src/PhpWord/Autoloader.php';
require '../../Classes/PHPWord-master/src/PhpWord/Autoloader.php';
...
echo file_get_contents('Historila Clinico.docx');

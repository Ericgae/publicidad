  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="input-group">
        ...
        <input type="hidden" class="form-control" id="idalmacen" name="idalmacen">
        <input type="hidden" class="form-control" id="fkempresa" name="fkempresa">
        </div>
        ...
        <input type="hidden" class="form-control" id="iddireccion" name="iddireccion">
        <input type="hidden" class="form-control" id="fkempresad" name="fkempresad">
        </div>

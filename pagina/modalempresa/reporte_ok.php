<?php
	...
	//Consulta
	$sql = "SELECT * FROM cita INNER JOIN persona ON persona.idpersona=cita.fkpersona order by apellidop";
	...
	$objPHPExcel->getProperties()->setCreator("Clinica Salud y Bienestar")->setDescription("REPORTE DE CITAS POR CLIENTES");
	...
	$objPHPExcel->getActiveSheet()->setCellValue('B3', 'REPORTE DE CITAS POR CLIENTES');
	...
	$objPHPExcel->getActiveSheet()->setCellValue('K6', 'ID CITA');
	$objPHPExcel->getActiveSheet()->getColumnDimension('L')->setWidth(30);
	$objPHPExcel->getActiveSheet()->setCellValue('L6', 'ASUNTO');
	$objPHPExcel->getActiveSheet()->getColumnDimension('M')->setWidth(30);
	$objPHPExcel->getActiveSheet()->setCellValue('M6', 'INICIO CITA');
	$objPHPExcel->getActiveSheet()->getColumnDimension('N')->setWidth(30);
	$objPHPExcel->getActiveSheet()->setCellValue('N6', 'FIN CITA');
	...
	while($rows = $resultado->fetch_assoc()){
		...
		$objPHPExcel->getActiveSheet()->setCellValue('L'.$fila, $rows['title']);
		$objPHPExcel->getActiveSheet()->setCellValue('M'.$fila, $rows['start']);
		$objPHPExcel->getActiveSheet()->setCellValue('N'.$fila, $rows['end']);
		$objPHPExcel->getActiveSheet()->setCellValue('O'.$fila, $rows['fecha']);

<?php
	...
	if (empty($_POST['idpersona'])) {
		...
		$tipo=mysqli_real_escape_string($con,(strip_tags($_POST["tipoc"],ENT_QUOTES)));
		$tel=mysqli_real_escape_string($con,(strip_tags($_POST["tel"],ENT_QUOTES)));
		$supo=mysqli_real_escape_string($con,(strip_tags($_POST["supo"],ENT_QUOTES)));
 ...
 $sql1="UPDATE cliente SET  fkPersona='".$idpersona."', tipoc='".$tipo."', supo='".$supo."' WHERE fkPersona='".$idpersona."'";

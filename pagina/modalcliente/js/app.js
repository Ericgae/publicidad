	function load(page){
		...
		$('#dataUpdate').on('show.bs.modal', function (event) {
		  ...
		  var tipoc = button.data('tipoc') // Extraer la información de atributos de datos
		  ...
		  var supo = button.data('supo') // Extraer la información de atributos de datos 
		  ...
		  modal.find('.modal-body #tipoc').val(tipoc)
		  ...
		  modal.find('.modal-body #supo').val(supo)

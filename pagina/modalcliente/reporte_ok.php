<?php
	...
	//Consulta
	$sql = "SELECT * FROM persona INNER JOIN cliente ON persona.idpersona=cliente.fkPersona  order by apeliidoP";
	...
	$objPHPExcel->getProperties()->setCreator("LLanta y Serviico Temoc ")->setDescription("Reporte de Pacientes");

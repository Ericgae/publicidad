...
$ididentificacion = $_POST['fkidentificacion'];
$fkfisioterapeuta = $_POST['fkfisioterapeuta'];
$fechab = $_POST['fechab'];
$faseterapia = $_POST['faseterapia'];
$observaciones = $_POST['observaciones'];
$nsesion = $_POST['nsesion'];
$costo = $_POST['costo'];
...
$sql= "INSERT INTO bitacora (fkidentificacion, fkfisioterapeuta, fechab, faseterapia, observaciones, nsesion, costo ) 
VALUES ('".$ididentificacion."','".$fkfisioterapeuta."','".$fechab."','".$faseterapia."','".$observaciones."','".$nsesion."','".$costo."')";
...
if($resultadoconsulta != 0)
{
		...
		<body>
		<meta http-equiv='REFRESH' content='0 ; url=../modalidentificacion/listaidentificacion.php'>
		<script>

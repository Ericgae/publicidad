<?php
	...
	# conectare la base de datos
     include ('../../connect_db.php');
		...
		$query = mysqli_query($con,"SELECT * FROM direccion INNER JOIN persona ON persona.idpersona=direccion.fkpersona  like '%$dato%' or calle LIKE '%$dato%' OR numero LIKE '%$dato%' OR estado LIKE '%$dato%' OR municipio LIKE '%$dato%' OR localidad LIKE '%$dato%' OR cpostal LIKE '%$dato%' order by apellidop desc LIMIT $offset,$per_page  ");

...
<div class="modal fade" id="dataRegister" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
 ...
 <div class="input-group">
    ...
    <input type="file" class="form-control-file" id="foto" name="foto">
        ...
        <input type="text" class="form-control" placeholder="345.50"  onKeyUp="this.value = this.value.toUpperCase();" maxlength="20" id="punitariod" name="punitariod" required>
        </div>
        <br>
        <div class="input-group">
        <span class="input-group-addon"> Precio 3:</span>
        <input type="text" class="form-control" placeholder="345.50"  onKeyUp="this.value = this.value.toUpperCase();" maxlength="20" id="punitariot" name="punitariot" required>
        </div>
        <br>
       <div class="input-group">

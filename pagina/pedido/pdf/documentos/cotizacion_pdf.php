<?php
	...
	$sql_count=mysqli_query($con,"select * from tmp_cotizacion2 where session_id='".$session_id."'");
	...
	$sql_cotizacion=mysqli_query($con, "select LAST_INSERT_ID(numero_cotizacion) as last from cotizaciones_demo2 order by id_cotizacion desc limit 0,1 ");

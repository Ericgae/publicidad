    ...
    <body>
      ...
      <?php include("../menu2.html"); ?>
        ...
        <div class="container-fluid">
            ...
            <h3 class='text-right'>
            <button type="button" class="btn btn-default" ><i class='glyphicon glyphicon-print'> </i><a href="http://localhost/proyectoestadia/paginas/app/reportes/reporteTutor.php" target="_blank"> Imprimir</a></button>
